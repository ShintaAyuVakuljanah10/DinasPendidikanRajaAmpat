    ...
    <div class="row mb-3 align-items-center g-3">
        ...
        <div class="col-md-3">
            <div class="dropdown w-100">
                <button class="btn btn-outline-info dropdown-toggle w-100 d-flex justify-content-between align-items-center"
                        ...
                        <div class="col-lg-4">
                            <div class="vstack gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-outline-info dropdown-toggle w-100 d-flex justify-content-between align-items-center" type="button" data-bs-toggle="dropdown">
                                            <span>-- Select --</span>
                                        </button>
                                        <ul class="dropdown-menu w-100">
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu w-100">
                                                <li><a class="dropdown-item dropdown-select" href="#" data-value="Pages" data-target="type">Pages</a></li>
                                                <li><a class="dropdown-item dropdown-select" href="#" data-value="Sub Pages" data-target="type">Sub Pages</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu w-100">
                                            <li><a class="dropdown-item dropdown-select" href="#" data-value="1" data-target="parent_id">Yes</a></li>
                                            <li><a class="dropdown-item dropdown-select" href="#" data-value="0" data-target="parent_id">No</a></li>
                                        </ul>
                                    </div>
                                </div>
